...
RasterizerService.prototype.startService = function() {
  var rasterizer = spawn(this.config.command, ['--ssl-protocol=any', '--ignore-ssl-errors=true', 'scripts/rasterizer.js', this.config.path, this.config.port, this.config.viewport]);
