 ...
 * @api public
 */
var FaviconService = function(config) {
...
FaviconService.prototype.rasterizerExitHandler = function (code) {
  if (this.isStopping) return;
  console.log('phantomjs failed; restarting');
  this.startService();
};

FaviconService.prototype.startService = function() {
  var rasterizer = spawn(this.config.command, ['--ssl-protocol=any', '--ignore-ssl-errors=true', 'scripts/favicon.js', this.config.path, this.config.port, this.config.viewport]);
...
FaviconService.prototype.killService = function() {
  if (this.rasterizer) {
...
FaviconService.prototype.restartService = function() {
  if (this.rasterizer) {
    this.killService();
    this.startService();
  }
...
FaviconService.prototype.pingService = function() {
  if (!this.rasterizer) {
...
FaviconService.prototype.checkHealth = function() {
...
FaviconService.prototype.getPort = function() {
  return this.config.port;
}

FaviconService.prototype.getPath = function() {
